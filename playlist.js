	  ...
	  _createClass(_class, [{
	    ...
	    */
	    ...
	    value: function renderControls(data) {
		  ...
		  (0, _h2.default)('div.btn-group', [(0, _h2.default)('span.btn.btn-default.btn-xs.btn-mute' + muteClass, {
	        onclick: function onclick() {
	          _this2.ee.emit('mute', _this2);
	        }
		  }, ['Mute']), 
		  
		  (0, _h2.default)('span.btn.btn-default.btn-xs.btn-solo' + soloClass, {
	        onclick: function onclick() {
	          _this2.ee.emit('solo', _this2);
	        }
		  }, ['Solo']),
		  
		  //custom delete track button
		   (0, _h2.default)('span.btn.btn-default.btn-xs.btn-delete' + soloClass, {
	        onclick: function onclick() {
	          console.log(_this2);
			  console.log('Delete clicked');
			  playlistDeleteTrackHandler(_this2);
	        }
		  }, [''])
